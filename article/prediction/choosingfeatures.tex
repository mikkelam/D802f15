...
In total only $0.2\%$ of the possible features appear in a single game. Given such level sparsity, we choose a sparse representation of features, as this reduces the memory footprint significant and allows us to use feature sets of a much larger size. This is an important detail, as very large feature sets can be useful when combined with big data methods. 
