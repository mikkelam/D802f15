...
\todo{Spørgsmål: Ville det give mening at alle 'w' her har samme font?}
...
One way of avoiding overfitting is by using a technique called cross validation. \todo{der skal være mere end 1 training set til cross validation}
