...
\todo{giver det ikke mening at bruge summen af h(x) fremfor summen af w_i phi_i?}

By minimising the loss function the value of the parameters can be determined.
