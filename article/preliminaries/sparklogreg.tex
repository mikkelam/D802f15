...
\todo{flyt source code til appendix}
...
The main function involved with calculating the weights is runMiniBatchSGD from line 149 in GradientDescent.scala. The runMiniBatchSGD is shown in \Cref{lst:runMiniBatchSGD}. \todo{Fix noget med \textbackslash ContiuedFloat}
