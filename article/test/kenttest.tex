...
\begin{figure}[!htb]
  ...
  \begin{tikzpicture}[] 
    \begin{axis}[
      ...
      \legend{Baseline,$\phi_\text{SINGLE}$, $\phi_\text{BEST-RANKED}$, $\phi_\text{PLAYER-RANKS}$,$\phi_\text{LANE-RANKS}$,$\phi_\text{LANE-CHAMPION}$}
    \end{axis} 
  \end{tikzpicture}
