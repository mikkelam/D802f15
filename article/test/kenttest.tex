...
For this experiments 35,000 matches are used, using the Weka tool as implementation \todo{ref weka}. The best accuracy we obtained with each of the tested machine learning techniques can be seen in \Cref{fig:besttech}. As seen, SVM and Neural networks got the worst accuracy. Naive bayes, adaboost and Hidden naive bayes all have an accuracy close to 56.5\%, but logistic regression has the best accuracy almost hitting 57\%.
