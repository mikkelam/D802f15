...
In this section we perform a number of experiments on a cluster setup described in \Cref{sec:clustersetup}. The cluster setup is important due to the large size of data used for these experiments.
